$(document).ready(function(){
  ...
  var $developmentBar = $('<ul>', {class: 'development-bar',
  ...
  var $baselineGrid = $('<div>', {class: 'development-baseline-grid', text: ''});
  var $960SkeletonGrid = $('<div>', {class: 'development-skeleton-960-grid', text: ''});
